...
examples = (
    ...
    ('0.0E+03', [ZeroToken, DotDelimiter, ZeroToken, EToken]),
    ('0.0e-1', [ZeroToken, DotDelimiter, ZeroToken, EToken]),
    ('0.0e+100%', [ZeroToken, DotDelimiter, ZeroToken, EToken, PercentageSymbol]),
